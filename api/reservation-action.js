import { updateReservation, deleteReservation, markSeen } from './_lib/store.js';
...
export default async function handler(req, res) {
  ...
  // Fired when staff open a reservation via the "new reservations" modal or
  // by tapping its push notification — clears it from the unseen badge/list.
  if (action === 'mark-seen') {
    await markSeen(week, id);
